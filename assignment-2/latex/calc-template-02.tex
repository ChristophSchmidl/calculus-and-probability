...
\author{
\global\Copy{name}{
 First and family name  % Fill in your name
} \\ 
\global\Copy{snumber}{
 student number  % Fill in your student number
} \\
\global\Copy{group}{
 Group x  % Fill in your assigned group
}}
...
\dots  % Put here your calculation
\global\Copy{exsixb}{
  Answer 6b% Put here the final answer
}
...
\global\Copy{exeighta}{
  Answer 8a% Put here the final answer, which is then also copied to the form on the last page
}
