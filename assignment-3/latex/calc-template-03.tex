...
\global\Copy{exsix}{
  Answer 6% Put here the final answer, which is then also copied to the form on the last page
}
...
\global\Copy{exsevena}{
  Answer 7a% Put here the final answer, which is then also copied to the form on the last page
}
...
\dots  % Put here your calculation
\global\Copy{exeight}{
  Answer 8% Put here the final answer, which is then also copied to the form on the last page
}
...
\dots  % Put here your calculation
\global\Copy{exninec}{
  Answer 9c% Put here the final answer, which is then also copied to the form on the last page
}

\item%d
\dots  % Put here your calculation
\global\Copy{exnined}{
  Answer 9d% Put here the final answer, which is then also copied to the form on the last page
}
